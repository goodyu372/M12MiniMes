...
namespace WHC.Attachment.DALPostgreSQL
{
    /// <summary>
    /// 相关附件信息
    /// </summary>
	public class FileUpload : BaseDALPostgreSQL<FileUploadInfo>, IFileUpload
	{
		#region 对象实例及构造函数
        ...
        public List<FileUploadInfo> GetAllByUser(string userId, string category, PagerInfo pagerInfo)
        {
            ...
            string condition = cond.BuildConditionSql().Replace("Where", "");
